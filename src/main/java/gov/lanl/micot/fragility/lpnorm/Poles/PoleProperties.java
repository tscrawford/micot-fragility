...
public class PoleProperties {
    ...
    private float cableSpan;
    private float commAttachmentHeight;
    private float commCableDiameter;
    private int commCableNumber;
    private float commCableWireDensity;
    private float height;
    private float meanPoleStrength;
    private float powerAttachmentHeight;
    private float powerCableDiameter;
    private int powerCableNumber;
    private float powerCableWireDensity;
